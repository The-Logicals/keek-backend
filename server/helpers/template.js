          ...
          <table cellspacing="0" cellpadding="0" border="0" summary="">
            <tr align="center">
              <td valign="middle" style="width: 100%;">
                <a href="#">
                  <img style="width: 125px; cursor: pointer" src="https://res.cloudinary.com/dnch08bzc/image/upload/v1592283069/Keek.png" alt="random">
                </a>
              </td>
            </tr>
          </table>
            ...
            <tr align="center">
              <td style="width: 100%; ">
                <div style="background: #EFEEEE; padding: 20px 0px">
                  <p style="line-height: 20px; font-size: 0.75rem; color: black;">You’re getting this message because your Keek account is connected to <a href="#">${email}</a><br />
